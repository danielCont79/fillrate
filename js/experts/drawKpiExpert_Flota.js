...
kpiExpert_Flota.DrawTooltipDetail=function(entity){    
    ...
    if($("#nivel_cb").val() > 2 ){
      ...
      kpiExpert_Flota.DrawTooltipDetail_Estado(entity);
    }
...
kpiExpert_Flota.DrawTooltipDetail_Estado=function(entity){   
    ...
    if(serviceName && apiURL){
            ...
            if(URL.indexOf("undefined" < 0)){
                ...
                dataLoader.AddLoadingTitle("Detalle de Flota por Estado");
                ...
                d3.json(URL, function (error, data) {
                          ...
                          if(error){
                            alert("Error API Detalle Flota Estado",error);
                            resolve();
                            return;
                          }

                          if(data.error){
                              alert("Error API Detalle Flota Estado",data.error);
                              resolve();
                              return;
                          }

                          console.log("Detalle Flota Estado",data.recordset); 
